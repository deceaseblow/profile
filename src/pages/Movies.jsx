...
const Movies = () => {
  ...
  const genres = ["All", "Action", "Adventure", "Comedy", "Drama", "Horror", "Romance", "Sci-Fi", "Thriller", "Fantasy", "Animation"];
    ...
    <div className="pb-10 px-4 md:px-10">
      ...
      <p className="text-center text-[22px] font-bold text-black md:text-start md:text-[20px]">
        {filteredMovies.length === 0
          ...
          : `Currently ${filteredMovies.length} ${filteredMovies.length === 1 ? "movie is" : "movies are"} found for your search.`}
      </p>
